...
async function loadSettings() {
  try {
    ...
    document.getElementById('weeklyDashboardTime').value = config.weeklyDashboardTime;
...
async function saveSettings(e) {
  ...
  try {
    const config = {
      ...
      weeklyDashboardTime: document.getElementById('weeklyDashboardTime').value,
